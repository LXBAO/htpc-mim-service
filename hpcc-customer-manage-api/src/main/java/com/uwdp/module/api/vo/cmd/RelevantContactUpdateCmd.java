...
@AllArgsConstructor
@ToString
@ApiModel(value = "RelevantContact UpdateCmd对象", description = "客户相关联系人", discriminator = "relevantContact")
public class RelevantContactUpdateCmd implements Serializable {
