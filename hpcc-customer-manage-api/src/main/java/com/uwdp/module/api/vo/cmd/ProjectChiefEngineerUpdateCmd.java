...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectChiefEngineer UpdateCmd对象", description = "项目总工", discriminator = "projectChiefEngineer")
public class ProjectChiefEngineerUpdateCmd implements Serializable {
