...
@AllArgsConstructor
@ToString
@ApiModel(value = "PerformanceLedgerExcelImport对象", description = "业绩台账", discriminator = "performanceLedger")
@SearchBean(tables = "T_PERFORMANCELEDGER")
@EqualsAndHashCode(callSuper = false)
public class PerformanceLedgerExcelImport extends BaseExcelDTO {
