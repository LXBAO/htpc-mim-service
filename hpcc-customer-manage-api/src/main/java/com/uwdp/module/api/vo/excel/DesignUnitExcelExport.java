...
@AllArgsConstructor
@ToString
@ApiModel(value = "DesignUnitExcelExport对象", description = "设计单位", discriminator = "designUnit")
@SearchBean(tables = "T_DESIGNUNIT")
@EqualsAndHashCode(callSuper = false)
public class DesignUnitExcelExport extends BaseExcelDTO {
