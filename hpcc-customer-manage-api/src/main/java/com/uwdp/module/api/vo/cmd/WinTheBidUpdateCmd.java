...
@AllArgsConstructor
@ToString
@ApiModel(value = "WinTheBid UpdateCmd对象", description = "项目中标", discriminator = "WinTheBid")
public class WinTheBidUpdateCmd implements Serializable {
    ...
    // @Length(max = 200, message = "homeProvinceName长度不在有效范围内")
