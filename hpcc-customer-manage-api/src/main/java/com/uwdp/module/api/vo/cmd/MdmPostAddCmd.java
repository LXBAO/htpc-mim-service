...
@AllArgsConstructor
@ToString
@ApiModel(value = "MdmPostAddCmd对象", description = "主数据-岗位", discriminator = "mdmPost")
public class MdmPostAddCmd implements Serializable {
    ...
    // @Range( message = "isDeleted长度不在有效范围内")
