...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectImplement UpdateCmd对象", description = "项目实施", discriminator = "projectImplement")
public class ProjectImplementUpdateCmd implements Serializable {
