...
@AllArgsConstructor
@ToString
@ApiModel(value = "SupervisionUnitExcelExport对象", description = "监理单位", discriminator = "supervisionUnit")
@SearchBean(tables = "T_SUPERVISIONUNIT")
@EqualsAndHashCode(callSuper = false)
public class SupervisionUnitExcelExport extends BaseExcelDTO {
