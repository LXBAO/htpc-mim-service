...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectManagerLedger UpdateCmd对象", description = "项目经理台账", discriminator = "projectManagerLedger")
public class ProjectManagerLedgerUpdateCmd implements Serializable {
