...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectSuspensionExcelImport对象", description = "项目中止", discriminator = "projectSuspension")
@SearchBean(tables = "T_PROJECTSUSPENSION")
@EqualsAndHashCode(callSuper = false)
public class ProjectSuspensionExcelImport extends BaseExcelDTO {
