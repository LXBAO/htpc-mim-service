...
@AllArgsConstructor
@ToString
@ApiModel(value = "ConstructionUnitExcelImport对象", description = "建设单位", discriminator = "constructionUnit")
@SearchBean(tables = "T_CONSTRUCTIONUNIT")
@EqualsAndHashCode(callSuper = false)
public class ConstructionUnitExcelImport extends BaseExcelDTO {
