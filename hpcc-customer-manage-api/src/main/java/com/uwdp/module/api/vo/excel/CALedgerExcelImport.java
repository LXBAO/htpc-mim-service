...
@AllArgsConstructor
@ToString
@ApiModel(value = "CALedgerExcelImport对象", description = "CA台账", discriminator = "CALedger")
@SearchBean(tables = "T_CALEDGER")
@EqualsAndHashCode(callSuper = false)
public class CALedgerExcelImport extends BaseExcelDTO {
...
//    private String fdWebsiteIcon;
    ...
    @ColumnWidth(16)
    @ExcelProperty(value = {"是否有证书"}, index = 7)
    ...
    @ColumnWidth(16)
    @ExcelProperty(value = {"是否实行电子招投标"}, index = 8)
    ...
    @DbField("CREATEDNAME")
    @ColumnWidth(16)
    @ExcelProperty(value = {"创建人名称"}, index = 16)
