...
@AllArgsConstructor
@ToString
@ApiModel(value = "PerformanceLedger UpdateCmd对象", description = "业绩台账", discriminator = "performanceLedger")
public class PerformanceLedgerUpdateCmd implements Serializable {
