...
@AllArgsConstructor
@ToString
@ApiModel(value = "ClientRoleEntityExcelImport对象", description = "权限表", discriminator = "ClientRoleEntity")
@SearchBean(tables = "T_CLIENTROLEENTITY")
@EqualsAndHashCode(callSuper = false)
public class ClientRoleEntityExcelImport extends BaseExcelDTO {
