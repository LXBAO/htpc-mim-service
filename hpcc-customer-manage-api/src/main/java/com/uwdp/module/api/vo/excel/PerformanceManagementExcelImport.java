...
@AllArgsConstructor
@ToString
@ApiModel(value = "PerformanceManagementExcelImport对象", description = "业绩管理", discriminator = "performanceManagement")
@SearchBean(tables = "T_PERFORMANCEMANAGEMENT")
@EqualsAndHashCode(callSuper = false)
public class PerformanceManagementExcelImport extends BaseExcelDTO {
