...
@AllArgsConstructor
@ToString
@ApiModel(value = "PerformanceManagementDTO对象", description = "业绩管理", discriminator = "performanceManagement")
@SearchBean(tables = "T_PERFORMANCEMANAGEMENT")
public class PerformanceManagementDto implements Serializable {
