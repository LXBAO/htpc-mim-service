...
@AllArgsConstructor
@ToString
@ApiModel(value = "MdmOrganizationExcelImport对象", description = "主数据-组织", discriminator = "mdmOrganization")
@SearchBean(tables = "T_MDMORGANIZATION")
@EqualsAndHashCode(callSuper = false)
public class MdmOrganizationExcelImport extends BaseExcelDTO {
