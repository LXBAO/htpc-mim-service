...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowVariableExcelExport对象", description = "流程表表单数据", discriminator = "LmcWorkflowVariable")
@SearchBean(tables = "T_LMCWORKFLOWVARIABLE")
@EqualsAndHashCode(callSuper = false)
public class LmcWorkflowVariableExcelExport extends BaseExcelDTO {
