...
@AllArgsConstructor
@ToString
@ApiModel(value = "UpdateViewDetail UpdateCmd对象", description = "更新查看详情", discriminator = "updateViewDetail")
public class UpdateViewDetailUpdateCmd implements Serializable {
