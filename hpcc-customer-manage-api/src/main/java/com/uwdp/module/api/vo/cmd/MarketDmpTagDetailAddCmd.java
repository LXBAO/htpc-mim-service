...
@AllArgsConstructor
@ToString
@ApiModel(value = "MarketDmpTagDetailAddCmd对象", description = "指标明细", discriminator = "market_dmp_tag_detail")
public class MarketDmpTagDetailAddCmd implements Serializable {
