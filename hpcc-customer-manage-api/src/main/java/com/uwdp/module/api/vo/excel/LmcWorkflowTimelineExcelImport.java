...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowTimelineExcelImport对象", description = "流程时间线", discriminator = "LmcWorkflowTimeline")
@SearchBean(tables = "T_LMCWORKFLOWTIMELINE")
@EqualsAndHashCode(callSuper = false)
public class LmcWorkflowTimelineExcelImport extends BaseExcelDTO {
