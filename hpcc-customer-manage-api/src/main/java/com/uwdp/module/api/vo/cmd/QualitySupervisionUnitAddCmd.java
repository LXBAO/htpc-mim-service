...
@AllArgsConstructor
@ToString
@ApiModel(value = "QualitySupervisionUnitAddCmd对象", description = "质量监督单位", discriminator = "qualitySupervisionUnit")
public class QualitySupervisionUnitAddCmd implements Serializable {
