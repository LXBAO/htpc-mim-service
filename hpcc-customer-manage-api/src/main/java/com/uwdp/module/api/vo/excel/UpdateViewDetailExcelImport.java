...
@AllArgsConstructor
@ToString
@ApiModel(value = "UpdateViewDetailExcelImport对象", description = "更新查看详情", discriminator = "updateViewDetail")
@SearchBean(tables = "T_UPDATEVIEWDETAIL")
@EqualsAndHashCode(callSuper = false)
public class UpdateViewDetailExcelImport extends BaseExcelDTO {
