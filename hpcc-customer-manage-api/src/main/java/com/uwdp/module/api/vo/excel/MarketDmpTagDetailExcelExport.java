...
@AllArgsConstructor
@ToString
@ApiModel(value = "MarketDmpTagDetailExcelExport对象", description = "指标明细", discriminator = "market_dmp_tag_detail")
@SearchBean(tables = "T_MARKET_DMP_TAG_DETAIL")
@EqualsAndHashCode(callSuper = false)
public class MarketDmpTagDetailExcelExport extends BaseExcelDTO {
    ...
    // @Range(max = Long.MAX_VALUE, message = "companyId长度不在有效范围内")
