...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectChiefEngineerExcelImport对象", description = "项目总工", discriminator = "projectChiefEngineer")
@SearchBean(tables = "T_PROJECTCHIEFENGINEER")
@EqualsAndHashCode(callSuper = false)
public class ProjectChiefEngineerExcelImport extends BaseExcelDTO {
