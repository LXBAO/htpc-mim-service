...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectChiefEngineerExcelExport对象", description = "项目总工", discriminator = "projectChiefEngineer")
@SearchBean(tables = "T_PROJECTCHIEFENGINEER")
@EqualsAndHashCode(callSuper = false)
public class ProjectChiefEngineerExcelExport extends BaseExcelDTO {
