...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectSigning UpdateCmd对象", description = "项目签约", discriminator = "ProjectSigning")
public class ProjectSigningUpdateCmd implements Serializable {
    ...
    // @Length(max = 200, message = "contractStatus长度不在有效范围内")
