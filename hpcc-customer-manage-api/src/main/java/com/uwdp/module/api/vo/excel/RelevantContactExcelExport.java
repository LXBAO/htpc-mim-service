...
@AllArgsConstructor
@ToString
@ApiModel(value = "RelevantContactExcelExport对象", description = "客户相关联系人", discriminator = "relevantContact")
@SearchBean(tables = "T_RELEVANTCONTACT")
@EqualsAndHashCode(callSuper = false)
public class RelevantContactExcelExport extends BaseExcelDTO {
