...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectChiefEngineerDTO对象", description = "项目总工", discriminator = "projectChiefEngineer")
@SearchBean(tables = "T_PROJECTCHIEFENGINEER")
public class ProjectChiefEngineerDto implements Serializable {
