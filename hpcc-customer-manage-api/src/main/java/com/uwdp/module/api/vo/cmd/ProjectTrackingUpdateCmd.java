...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectTracking UpdateCmd对象", description = "项目跟踪", discriminator = "projectTracking")
public class ProjectTrackingUpdateCmd implements Serializable {
