...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowConfig UpdateCmd对象", description = "流程配置表", discriminator = "LmcWorkflowConfig")
public class LmcWorkflowConfigUpdateCmd implements Serializable {
