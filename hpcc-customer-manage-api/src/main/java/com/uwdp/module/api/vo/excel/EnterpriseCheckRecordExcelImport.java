...
@AllArgsConstructor
@ToString
@ApiModel(value = "EnterpriseCheckRecordExcelImport对象", description = "企查查记录", discriminator = "enterpriseCheckRecord")
@SearchBean(tables = "T_ENTERPRISECHECKRECORD")
@EqualsAndHashCode(callSuper = false)
public class EnterpriseCheckRecordExcelImport extends BaseExcelDTO {
