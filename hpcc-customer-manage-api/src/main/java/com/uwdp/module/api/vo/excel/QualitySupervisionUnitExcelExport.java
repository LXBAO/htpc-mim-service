...
@AllArgsConstructor
@ToString
@ApiModel(value = "QualitySupervisionUnitExcelExport对象", description = "质量监督单位", discriminator = "qualitySupervisionUnit")
@SearchBean(tables = "T_QUALITYSUPERVISIONUNIT")
@EqualsAndHashCode(callSuper = false)
public class QualitySupervisionUnitExcelExport extends BaseExcelDTO {
