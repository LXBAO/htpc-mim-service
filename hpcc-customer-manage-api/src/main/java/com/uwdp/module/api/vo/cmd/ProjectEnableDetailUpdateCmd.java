...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectEnableDetail UpdateCmd对象", description = "项目赋能明细", discriminator = "projectEnableDetail")
public class ProjectEnableDetailUpdateCmd implements Serializable {
