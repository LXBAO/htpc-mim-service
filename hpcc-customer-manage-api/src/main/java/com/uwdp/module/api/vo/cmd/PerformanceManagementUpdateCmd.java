...
@AllArgsConstructor
@ToString
@ApiModel(value = "PerformanceManagement UpdateCmd对象", description = "业绩管理", discriminator = "performanceManagement")
public class PerformanceManagementUpdateCmd implements Serializable {
