...
@SearchBean(
        tables = "T_PROJECTBIDDING p left join T_PROJECTRECORDS r on p.PROJECTNUMBER = r.ID left join T_LINKMAN lm on p.projectNumber = lm.biddingId left join T_LMCWORKFLOW l on p.ID =  l.BIZID"
)
public class ProjectBiddingWorkflowDto implements Serializable {
