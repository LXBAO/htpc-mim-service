...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectEnableDetailExcelImport对象", description = "项目赋能明细", discriminator = "projectEnableDetail")
@SearchBean(tables = "T_PROJECTENABLEDETAIL")
@EqualsAndHashCode(callSuper = false)
public class ProjectEnableDetailExcelImport extends BaseExcelDTO {
