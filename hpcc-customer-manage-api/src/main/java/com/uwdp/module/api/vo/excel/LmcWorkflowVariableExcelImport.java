...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowVariableExcelImport对象", description = "流程表表单数据", discriminator = "LmcWorkflowVariable")
@SearchBean(tables = "T_LMCWORKFLOWVARIABLE")
@EqualsAndHashCode(callSuper = false)
public class LmcWorkflowVariableExcelImport extends BaseExcelDTO {
