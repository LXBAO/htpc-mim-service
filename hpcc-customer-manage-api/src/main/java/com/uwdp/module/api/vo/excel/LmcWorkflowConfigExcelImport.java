...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowConfigExcelImport对象", description = "流程配置表", discriminator = "LmcWorkflowConfig")
@SearchBean(tables = "T_LMCWORKFLOWCONFIG")
@EqualsAndHashCode(callSuper = false)
public class LmcWorkflowConfigExcelImport extends BaseExcelDTO {
