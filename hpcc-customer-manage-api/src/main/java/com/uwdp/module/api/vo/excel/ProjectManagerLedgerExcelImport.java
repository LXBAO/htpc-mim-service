...
@AllArgsConstructor
@ToString
@ApiModel(value = "ProjectManagerLedgerExcelImport对象", description = "项目经理台账", discriminator = "projectManagerLedger")
@SearchBean(tables = "T_PROJECTMANAGERLEDGER")
@EqualsAndHashCode(callSuper = false)
public class ProjectManagerLedgerExcelImport extends BaseExcelDTO {
