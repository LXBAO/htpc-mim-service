...
@AllArgsConstructor
@ToString
@ApiModel(value = "CertificatesExcelImport对象", description = "荣誉证书", discriminator = "certificates")
@SearchBean(tables = "T_CERTIFICATES")
@EqualsAndHashCode(callSuper = false)
public class CertificatesExcelImport extends BaseExcelDTO {
...
//    private String id;
    ...
    @DbField("AWARDTIME")
    @ColumnWidth(16)
    @ExcelProperty(value = {"授奖时间"}, index = 3)
...
//    private String file;
    ...
    @DbField("TAKEBE")
    @ColumnWidth(16)
    @ExcelProperty(value = {"是否报党建部(0:否;1:是。"}, index = 6)
