...
@AllArgsConstructor
@ToString
@ApiModel(value = "PublicRelations UpdateCmd对象", description = "公关实施", discriminator = "publicRelations")
public class PublicRelationsUpdateCmd implements Serializable {
