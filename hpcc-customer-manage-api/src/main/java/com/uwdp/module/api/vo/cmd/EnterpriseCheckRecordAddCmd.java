...
@AllArgsConstructor
@ToString
@ApiModel(value = "EnterpriseCheckRecordAddCmd对象", description = "企查查记录", discriminator = "enterpriseCheckRecord")
public class EnterpriseCheckRecordAddCmd implements Serializable {
