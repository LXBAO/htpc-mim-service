...
@AllArgsConstructor
@ToString
@ApiModel(value = "ClientRoleEntity UpdateCmd对象", description = "权限表", discriminator = "ClientRoleEntity")
public class ClientRoleEntityUpdateCmd implements Serializable {
