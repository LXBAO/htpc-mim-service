...
@AllArgsConstructor
@ToString
@ApiModel(value = "WeeklyReportDetail UpdateCmd对象", description = "周报明细表", discriminator = "weekly_Report_Detail")
public class WeeklyReportDetailUpdateCmd implements Serializable {
