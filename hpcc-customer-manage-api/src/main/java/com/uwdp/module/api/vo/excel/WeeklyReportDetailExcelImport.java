...
@AllArgsConstructor
@ToString
@ApiModel(value = "WeeklyReportDetailExcelImport对象", description = "周报明细表", discriminator = "weekly_Report_Detail")
@SearchBean(tables = "T_WEEKLY_REPORT_DETAIL")
@EqualsAndHashCode(callSuper = false)
public class WeeklyReportDetailExcelImport extends BaseExcelDTO {
