...
@AllArgsConstructor
@ToString
@ApiModel(value = "SupervisionUnit UpdateCmd对象", description = "监理单位", discriminator = "supervisionUnit")
public class SupervisionUnitUpdateCmd implements Serializable {
