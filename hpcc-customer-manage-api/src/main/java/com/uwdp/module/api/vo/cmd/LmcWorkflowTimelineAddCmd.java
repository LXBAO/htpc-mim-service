...
@AllArgsConstructor
@ToString
@ApiModel(value = "LmcWorkflowTimelineAddCmd对象", description = "流程时间线", discriminator = "LmcWorkflowTimeline")
public class LmcWorkflowTimelineAddCmd implements Serializable {
