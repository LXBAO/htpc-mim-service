 ...
 */
@RestController
@RequestMapping("/hpcc-customer-manage/v1_0/module/project-bidding-v1-0-0")
@Api(tags = "项目投标")
...
//            }
    ...
    @PutMapping("/update")
    @ApiOperation(value = "编辑接口", notes="ProjectBidding")
    @OperationLog(type = OperateTypeEnum.UPDATE)
    public Response update(@RequestBody @Validated ProjectBiddingUpdateCmd updateCmd) {
        try {
            projectBiddingService.update(updateCmd);
            return Response.buildSuccess();
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    ...
    @ApiOperation(value = "删除接口", notes="ProjectBidding")
    ...
    public Response delete(@ApiParam(value = "主键", required = true) @RequestParam(name = "id") Long id,@RequestParam(name = "projectNumber") String projectNumber) {
        try {
            projectBiddingService.delete(id,projectNumber);
    ...
    @ApiOperation(value = "批量删除接口, ids以逗号分隔多个id", notes="ProjectBidding")
    @OperationLog(type = OperateTypeEnum.DELETE)
    public Response batchDelete(@ApiParam(value = "主键列表, 多个主键以逗号分割", required = true) @RequestParam(name = "ids") String ids,
        ...
        try {
            projectBiddingService.batchDelete(ids,numbers);
            return Response.buildSuccess();
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    ...
    @ApiOperation(value = "下载Excel模板", notes="ProjectBidding")
    @OperationLog(type = OperateTypeEnum.DOWNLOAD)
    public void excelTemplate(HttpServletResponse response) {
        try {
            projectBiddingService.excelTemplate(response);
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    }
    ...
    @ApiOperation(value = "导出Excel数据, 最多3000条", notes="ProjectBidding")
    ...
    public void excelExport(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            projectBiddingService.excelExport(map, response);
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    }
    ...
    @ApiOperation(value = "解析上传的Excel数据", notes="ProjectBidding")
    public SingleResponse<ExcelParseDTO<ProjectBiddingExcelImport>> excelParse(@RequestParam(value = "file", required = false) MultipartFile file) {
        try {
            return SingleResponse.of(projectBiddingService.excelParse(file));
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    }
    ...
    @ApiOperation(value = "导入处理后的Excel数据", notes="ProjectBidding")
    @OperationLog(type = OperateTypeEnum.IMPORT)
    public Response excelImport(@RequestBody @Valid List<ProjectBiddingExcelImport> list) {
        try {
            projectBiddingService.excelImport(list);
            return Response.buildSuccess();
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    ...
    @ApiOperation(value = "导出错误的数据", notes="ProjectBidding")
    @OperationLog(type = OperateTypeEnum.DOWNLOAD)
    public void excelErrorDownload(@RequestBody List<ProjectBiddingExcelExport> list, HttpServletResponse response) {
        try {
            projectBiddingService.excelErrorDownload(list, response);
        } catch (Exception e) {
            throw new BizRuntimeException(e);
        }
    }
