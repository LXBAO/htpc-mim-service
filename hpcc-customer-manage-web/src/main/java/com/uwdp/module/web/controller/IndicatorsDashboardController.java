 ...
 */
@RestController
@RequestMapping("/hpcc-customer-manage/v1_0/module/indicators-dashboard")
@Api(tags = "首页仪表盘")
@RequiredArgsConstructor
@OperationModule(type = ModuleTypeEnum.APP, business = "首页仪表盘")
public class IndicatorsDashboardController {
    ...
    @ApiOperation(value = "领域统计", notes = "designUnit")
